...
**Current edition: v3.5, 11 September 2026, prepared for Mohsin Chowdhury.** 38 pages, paginated.

## Contents

| File | What it is |
|------|-----------|
| [`index.html`](index.html) | **The artifact (v3.5)** — 38 numbered A4 pages. Open in a browser; print to PDF at 100% for true-scale drawings. |
| [`Bar-X-Ranch-4-Lot-Feasibility-v3.5.pdf`](Bar-X-Ranch-4-Lot-Feasibility-v3.5.pdf) | **Rendered PDF of the current edition** — A4, 38 pages, true scale. |
